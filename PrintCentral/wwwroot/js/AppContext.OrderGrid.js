var OrderGrid = function (element, controller) {
...
var OrderGridRows = function (container, headers, controller) {
	...
	function updateRowInfo(j) {
		...
		var elm = row.Element;
		var cssRowClass = GetRowCssClass(j);
		elm.className = `gvrow ${cssRowClass}`;
	...
	var self = {
		...
		Select: function (idx, clearPrev) {
			var clearPrevious = clearPrev == null && !multiselect ? true : clearPrev;
			var row = rows[idx];
