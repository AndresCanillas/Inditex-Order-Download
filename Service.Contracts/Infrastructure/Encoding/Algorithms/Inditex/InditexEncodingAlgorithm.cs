...
{
	public class InditexEncodingAlgorithm : ITagEncodingAlgorithm, IConfigurable<InditexEncodingConfig>
	{
		protected Tempe128 tag;
        protected InditexEncodingConfig config;

		public InditexEncodingAlgorithm(IFactory factory)
		{
	...
	public class InditexEncodingConfig
	{
