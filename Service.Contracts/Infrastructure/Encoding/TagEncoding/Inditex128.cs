...
{
    public class Inditex128 : TagEncoding, ITagEncoding
    {
        ...
        public Inditex128()
        {
            fields = new BitFieldInfo[]{
                ...
                new BitFieldInfo("WDate",           15,  17, BitFieldFormat.Decimal, false, false, null, null),
        ...
        public void SetWriteDate(string batchDate)
        {
            fields[8].Value = batchDate.ToString();
        }

        public string GetWriteDate()
        {
            return fields[8].Value.ToString();
        }
