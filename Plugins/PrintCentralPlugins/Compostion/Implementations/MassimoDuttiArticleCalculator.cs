...
{
    public class MassimoDuttiArticleCalculator
    {
        ...
        public MassimoDuttiArticleCalculator(IPrinterJobRepository printerJobRepo, IFactory factory, INotificationRepository notificationRepo, IArticleRepository articleRepo)
        {
        ...
        private List<ArticleSizeCategory> GetArticleCategoryList(string articleCode, StringBuilder additionals, int allCompoPages, int allAdditionalPages, int page1_totallines)
        {
            ...
            switch(articleCode)
            {
                ...
                case "COMPO-110x25-BLACK":
                    ...
                    {
                        compoCode = "0";
                        articleCategoryList.Add(new ArticleSizeCategory { ArticleCode = articleCode + "_" + compoCode, PageQuantity = 0 });
                    ...
                    else
                    {
                        ...
                        if(sum_pages_compo_addcare >= 1 && sum_pages_compo_addcare <= 13)
                        {
                            ...
                            articleCategoryList.Add(new ArticleSizeCategory { ArticleCode = articleCode + "_" + compoCode, PageQuantity = sum_pages_compo_addcare });
                        }
                ...
                case "24MDC-PP-CARE":
                case "24MDH-0201-CW":
                    articleCategoryList.Add(new ArticleSizeCategory { ArticleCode = articleCode, PageQuantity = 1 });
                    break;
            }
            return articleCategoryList;
        }
