...
namespace SmartdotsPlugins.Inditex.PullAndBear
{
    [FriendlyName("PB - Composition Text Plugin")]
    [Description("Inditex.PB - Composition Plugin")]
    public class PBCompoPluginR : IWizardCompositionPlugin
    {
        ...
        public PBCompoPluginR(IFactory factory)
        {
        ...
        private void ConfigureCustomServices()
        {
            this.compoPreviewDataBuilder.SetCustomServices(articleCodeExtractor: factory.GetInstance<ArticleCodeExtractor>(),
                                                          ...
                                                          inditexLanguageDictionaryManager: factory.GetInstance<PBLanguageDictionaryManager>(),
            ...
            this.compositionRepository.SetCustomServices(separatorsInitializator: factory.GetInstance<SeparatorsInit>(),
                                                            ...
                                                            languageDictionaryManager: factory.GetInstance<PBLanguageDictionaryManager>(),
                                                            ...
                                                            articleCompositionConfiguration: factory.GetInstance<ArticleCompositionConfigManager>());
            this.compositionCloneManager.SetCustomServices(inditexLanguageDictionaryManager: factory.GetInstance<PBLanguageDictionaryManager>(),
